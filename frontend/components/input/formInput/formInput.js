    ...
    <div className="col-span-full mt-4">
      ...
      <div className="relative mt-2 rounded-md shadow-sm">
        <input
          ...
          id={id}
          value={value}
          className={`block w-full rounded-md focus:outline-ourPrimaryColor border ${borderStyle} py-2 px-4 text-ourSuperDarkGray ring-1 ring-inset ring-ourLightGray placeholder:text-sm placeholder:text-ourGray focus:ring-2 focus:ring-inset`}
